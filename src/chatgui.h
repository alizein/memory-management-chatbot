...
private:
    ...
    // azein: (T1) turn raw pointer used into smart unique pointer to ChatLogic
...
public:
    ...
    // getter / setter
    // azein: (T1) return the address of the chatlogic instance on heap through smart pointer
